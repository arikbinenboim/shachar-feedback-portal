...
export default function SignInButton({ callbackUrl }: { callbackUrl: string }) {
  return (
    <button
      ...
      className="flex items-center gap-3 px-8 py-4 rounded-xl font-bold text-lg transition-all duration-200 shadow-lg hover:shadow-xl active:scale-[0.98]"
      style={{ background: 'var(--gold)', color: 'var(--accent)' }}
    >
